...

{
  ...
  img: "img/02.jpg",
  lyrics:`Cheena so sound, so titty up this malchick, say
...

{
  ...
  artist: "The Strokes",
  year: "2020",
  note: "good for crying on loop",
  src: "music/03_ode_to_mets.mp3",
  img: "img/03.jpg",
  lyrics: `Up on his horse, up on his horse
...

{
  ...
  year: "1966",
  note: `"But You Can Never Go Home Anymore"`,
  src: "music/04 _I_Can_Never_Go_Home_Anymore.mp3",
  img: "img/04.png",
  lyrics: `I'm gonna hide if she don't leave me alone
...
Asleep in the sand with the ocean washing over`
  ...
  
  {
    ...
    artist: "Lera Leynn",
    year: "2015",
    note: "you loved this song",
    src: "music/06_My_Least_Favorite_Life.mp3",
    img: "img/06.jpg",
    lyrics:`This is my least favorite life
...
Lost now forever, my love, in a sweet memory`
 ...
 
  {
    ...
    year: "2011",
    note: "nothing dramatic,just gone",
    src: "music/07_Goodbye.mp3",
    img: "img/07.jpg",
    lyrics:`Please put me to bed
...

{
  ...
  year: "1988",
  note: "this is a place, not a song",
  ...
  },
{
    ...
    artist: "Massive Attack",
    year: "1998",
    note: "keep staying inside that feeling",
    src: "music/09_group_four.mp3",
    img: "img/08.jpg",
    lyrics: `A flask I drink of sober tea
...

{
    ...
    artist: "Massive Attack",
    year: "2010",
    note: "this is the one i live in",
    src: "music/10_splitting.mp3",
    img: "img/10.jpg",
    lyrics: `The baby was born, nettles and ferns
  ...
  },
{
    ...
    artist: "UNKLE",
    year: "1998",
    note: "if i were a rabbit in your headlights",
    src: "music/11_rabbit.mp3",
    img: "img/11.png",
    lyrics:`I'm a rabbit in your headlights
...

{
    ...
    artist: "Portishead",
    year: "1997",
    note: "some things survive reason, sadly",
    src: "music/12_undenied.mp3",
    img: "img/12.jpg",
    lyrics: `Your softly spoken words
  ...
  },
{
    ...
    artist: "Portishead",
    year: "1997",
    note: "sometimes i inhabit this song",
    src: "music/13_Western_Eyes.mp3",
    img: "img/12.jpg",
    lyrics:`Forgotten throes at another's lie
The heart of love is our only light
Faithless greed, consolidating
...

{
    ...
    artist: "Portishead",
    year: "1997",
    note: "i dont trust this song",
    src: "music/14_cowboys.mp3",
    img: "img/12.jpg",
    lyrics: `Did you sweep us far from your feet?
  ...
  },
{
    ...
    artist: "Woven Hand",
    year: "2002",
    note: "it carried me through weird places. maybe it will for you too.",
...
You are the reason, I stay alive`
...

  {
    ...
    artist: "Nine Inch Nails",
    year: "1999",
    note: "i love the silence after the end of everything",
    src: "music/17_the_day.mp3",
    img: "img/17.jpg",
    lyrics: `I'd listen to the words he'd say
  ...
  },
{
    ...
    year: "2007",
    note: "چون مرلین منسن آدم شریفیه",
    src: "music/18_if_i_was.mp3",
    img: "img/11.png",
    lyrics:`6AM, Christmas morning
  ...
  },
{
    ...
    year: "1998",
    note: "dont take this one too seriously lol",
    src: "music/19_placebo.mp3",
    img: "img/19.jpg",
    lyrics: `Strange infatuation seems to grace the evening tide
...

{
    ...
    artist: "The Antlers",
    year: "2009",
    note: "Please remain with the patient",
    src: "music/21_Kettering.mp3",
    img: "img/21.jpg",
    lyrics:`I wish that I had known in that first minute we met
...
But I'll keep coming`,
...

 {
    ...
    year: "2005",
    note: "PLEASE play this at my funeral",
    src: "music/22_dondante.mp3",
    lyrics: `In a dream I saw you walk
...

{
    ...
    img: "img/23.jpg",
    lyrics: `Drag him out the window
  ...
  
{
    ...
    artist: "The Dø",
    year: "2014",
    note: "Nostalgic for a childhood that never existed",
    src: "music/24_miracles.mp3",
    img: "img/24.jpg",
    lyrics:`I still have some pictures on my wall
...

{
    ...
    year: "1960",
    note: "Afterwards",
    src: "music/25_sometimes.mp3",
    lyrics: `Sometimes I feel like a motherless child
